                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Valor da Parcela</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('operation_type_id') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::select('operation_type_id', $operations, 1, ['class' => 'form-control', 'disabled' => 'disabled']) }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('value_desired') ? ' has-error' : '' }}">
                                                <label class="col-form-label" for="value_desired">Valor Desejado</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="fa fa-money"></i></span>
                                                    </div>
                                                    {{ Form::text('value_desired', null, ['class' => 'form-control', 'placeholder'=>'Informe o valor']) }}
                                                </div>
                                                @if ($errors->has('value_desired'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('value_desired') }}</strong>
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
