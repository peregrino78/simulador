...
@section('title', 'Novo Coeficiente')

@section('content')

{!! Form::open(['route' => 'coeficientes.store', 'method' => 'post', 'class'=>'form-horizontal', 'role'=>'form', 'files' => true]) !!}
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('term') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('term', null, ['class' => 'form-control', 'placeholder'=>'Informe o prazo']) }}
                                                </div>
                                                @if ($errors->has('term'))
                                                    <span class="help-block">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('rate') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('rate', null, ['class' => 'form-control', 'placeholder'=>'Informe a taxa']) }}
                                                </div>
                                                @if ($errors->has('rate'))
                                                    <span class="help-block">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('factor') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('factor', null, ['class' => 'form-control', 'placeholder'=>'Informe o fator']) }}
                                                </div>
