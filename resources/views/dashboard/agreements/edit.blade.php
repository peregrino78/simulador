                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('name', $agreement->name, ['class' => 'form-control', 'placeholder'=>'Informe o nome']) }}
                                                </div>
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    {{ Form::textarea('description', $agreement->particularities->description, ['class' => 'form-control summernote']) }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('age_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::number('age_limit', $agreement->particularities->age_limit, ['class' => 'form-control', 'placeholder'=>'Limite de idade']) }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('parcel_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::number('parcel_limit', $agreement->particularities->parcel_limit, ['class' => 'form-control', 'placeholder'=>'Limite de parcelas']) }}
                                                </div>
